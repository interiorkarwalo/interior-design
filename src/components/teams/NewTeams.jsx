...
const NewTeams = () => {
  return (
    <section class="relative py-24 lg:pb-28 bg-gray-100 overflow-hidden">
      <div
        class="absolute top-0 left-0 w-24 md:w-96 h-full"
        style={{
          background:
      ...
      ></div>
      <div
        class="absolute top-0 right-0 w-24 md:w-96 h-full transform rotate-180"
        style={{
          background:
            'linear-gradient(90deg, #F3F7FA 10.94%, rgba(243, 247, 250, 0) 100%)',
        }}
      ...
      <div class="container px-4 mx-auto">
        <div class="relative max-w-xl text-center mx-auto mb-16">
          <h2 class="font-heading mb-4 text-6xl tracking-tighter">
