            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-4 mb-12">
              <div class="text-center">
                <span class="inline-block mb-2">
                  ...
                  >
                    <path
                      d="M28.6667 20.6667C29.04 20.6667 29.3333 20.9601 29.3333 21.3334V22.6667C29.3333 24.8801 27.5467 26.6667 25.3333 26.6667C25.3333 24.4667 23.5333 22.6667 21.3333 22.6667C19.1333 22.6667 17.3333 24.4667 17.3333 26.6667H14.6667C14.6667 24.4667 12.8667 22.6667 10.6667 22.6667C8.46666 22.6667 6.66666 24.4667 6.66666 26.6667C4.45333 26.6667 2.66666 24.8801 2.66666 22.6667V20.0001C2.66666 19.2667 3.26666 18.6667 4 18.6667H16.6667C18.5067 18.6667 20 17.1734 20 15.3334V8.00008C20 7.26675 20.6 6.66675 21.3333 6.66675H22.4533C23.4133 6.66675 24.2933 7.18675 24.7733 8.01342L25.6267 9.50675C25.7467 9.72008 25.5867 10.0001 25.3333 10.0001C23.4933 10.0001 22 11.4934 22 13.3334V17.3334C22 19.1734 23.4933 20.6667 25.3333 20.6667H28.6667Z"
                      fill="#C6FF53"
                    ></path>
                    <path
                    ...
                    ></path>
                    <path
                      d="M21.3333 29.3333C22.8061 29.3333 24 28.1394 24 26.6667C24 25.1939 22.8061 24 21.3333 24C19.8606 24 18.6667 25.1939 18.6667 26.6667C18.6667 28.1394 19.8606 29.3333 21.3333 29.3333Z"
                      fill="#C6FF53"
                    ></path>
                    <path
